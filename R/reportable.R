...
# In the code above, we are going to set up the frame for thia digital table and define what `buttons` we
#essentially want and how they will operate. See scwaterdemand, folder = wwww, file= permits to see this function work
...
# In this code chunk, we are defining the height and width of the rows and columns
# however, we do not want a row index. But the search bar does exist and work even though it is set to FALSE
